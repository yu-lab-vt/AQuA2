...
%         delete(axNow.Children(1:nFlex));
    ...
    if(opts.singleChannel)
        ui.over.addBd(f,axNow,btSt.evtMngrMsk1,[1 0.85 0],n,1);
        ui.over.addBd(f,axNow,btSt.rmLst1,[1 0.25 0.25],n,1);
    else
        ui.over.addBd(f,axNow,btSt.evtMngrMsk1,[0 1 0.85],n,1);
        ui.over.addBd(f,axNow,btSt.evtMngrMsk2,[1 0 0.85],n,2);
        ui.over.addBd(f,axNow,btSt.rmLst1,[0.25 1 0.25],n,1);
        ui.over.addBd(f,axNow,btSt.rmLst2,[1 0.25 0.25],n,1);
    end
end
